            ...
            <table class="table table-striped">
                <thead>
                    <tr>
                        ...
                        @canany(['kasir', 'produksi', 'pelanggan'])
                    ...
                    @foreach ($progres as $item)
                        <tr>
                            ...
                            @else
                                <td>
                                    <button wire:click="pembayaran({{ $item->id }})" type="button"
                                        class="btn btn-sm btn-success mr-2">Detail</button>
                                    <button wire:click="pembayaran({{ $item->id }})" type="button"
                                        class="btn btn-sm btn-success mr-2">Invoice</button>
                                </td>
                            @endcanany
                        </tr>
                    @endforeach
